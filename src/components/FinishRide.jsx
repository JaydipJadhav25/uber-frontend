...
export default function FinishRide() {
  return (
    ...
    <div className="w-screen h-screen flex justify-center">
          ...
          <h1 className="text-2xl font-bold p-4">Finish Ride</h1>
          ...
          <div className="text-black pl-4 border-b-2 border-gray-200">
            ...
            <p className="text-black">17th cross Rd.PWD Quarters , 1st sector</p>
                 ...
                 className="bg-green-700 p-4 rounded-2xl text-white text-lg text-center"> Finish Ride 
                  </Link>
           ...
           <h1 className="text-red-700 text-lg">click the finish ride if your have complete the payment </h1>   
