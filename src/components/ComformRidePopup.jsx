...
export default function ComformRidePopup(props) {
  ...
  return (
   ...
   <div className="w-screen h-screen flex justify-center">
         ...
         <h1 className="text-2xl font-bold p-4">Comfirm this Ride to Start</h1>

         <div className="w-full flex items-center justify-between bg-orange-400 rounded-lg p-5">
            <div className="flex">
         ...
         <div className="text-black pl-4 border-b-2 border-gray-200">
           ...
           <p className="text-black">17th cross Rd.PWD Quarters , 1st sector</p>
                 ...
                 <Link to="/captionriding"
            
                className="bg-green-700 p-4 rounded-2xl text-white text-lg text-center"> Comfirm 
                 </Link>

<button
onClick={()=>{
    props.setcomfomridepopuppanel(false)
    props.setridepopuppanel(false);
}}
          className="bg-red-700 p-4 rounded-2xl text-white text-lg">Cancel</button>
